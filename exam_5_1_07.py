...
if ((col1-col2==1 or col1-col2==-1) and (row1-row2==2 or row1-row2==-2)) or ((col1-col2==2 or col1-col2==-2) and (row1-row2==1 or row1-row2==-1)):
    print('YES')
else:
    print("NO")

'''
if (col1-col2==abs(1) and row1-row2==abs(2)) or (col1-col2==abs(2) and row1-row2==abs(1)):
    print('YES')
else:
    print("NO")
'''    
